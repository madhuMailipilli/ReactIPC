...
const UserDetails = () => {
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center h-96 gap-4">
        ...
        <span className="text-[10px] font-medium text-slate-400 uppercase tracking-widest animate-pulse">Accessing User Record...</span>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-7xl mx-auto py-20 text-center">
        <div className="inline-flex items-center gap-3 px-6 py-4 rounded-3xl bg-rose-50 border border-rose-100 text-rose-600">
          ...
          <span className="text-sm font-medium uppercase tracking-widest">{error.message}</span>
        </div>
      </div>
    );
  }
  ...
  if (!userData) {
    return (
      <div className="max-w-7xl mx-auto py-20 text-center">
        <div className="text-[10px] font-medium text-slate-400 uppercase tracking-widest">User Not Found</div>
      </div>
    );
  }
  ...
  const user = {
    ...
    createdDate: new Date(userData.created_at).toLocaleDateString(),
    lastLogin: userData.last_login_at ? new Date(userData.last_login_at).toLocaleDateString() : 'Never'
  };
    ...
    <div className="max-w-6xl mx-auto space-y-6 animate-in fade-in duration-700 pb-12">
        ...
        <div className="p-6 bg-[#1B3C53] relative overflow-hidden">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
            <div className="flex items-center gap-5">
              ...
              <div>
                <h1 className="text-2xl font-medium text-white tracking-tight">User Details</h1>
      ...
      <div className="grid grid-cols-1 gap-6">
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-[0_10px_30px_rgba(27,60,83,0.05)] border border-slate-100 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                <DetailItem label="Full Name" value={`${user.firstName} ${user.middleName} ${user.lastName}`.trim()} />
          ...
          {/* Address & Location */}
          <div className="bg-white rounded-2xl shadow-[0_10px_30_rgba(27,60,83,0.05)] border border-slate-100 overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-50 bg-slate-50/30 flex items-center gap-3">
              <div className="flex items-center gap-3">
