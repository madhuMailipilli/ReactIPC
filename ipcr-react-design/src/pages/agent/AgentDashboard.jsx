...
const AgentDashboard = () => {
  ...
  return (
    <div className="space-y-4 pt-1 pb-4">
      ...
      {/* Filter Section */}
      <div className="bg-white rounded-2xl border border-white p-6 shadow-xl shadow-blue-900/10 mb-6">
        <div className="flex flex-col sm:flex-row lg:flex-row lg:items-start gap-6">
          ...
          <div className="flex flex-col sm:flex-row gap-6">
            ...
            <div className="flex-shrink-0 flex items-end">
              <button 
                ...
                className="bg-slate-50 hover:bg-slate-100 text-slate-500 text-[10px] font-medium px-6 py-3.5 rounded-xl transition-all flex items-center gap-2 uppercase tracking-widest border border-slate-100 shadow-sm active:scale-95"
              >
